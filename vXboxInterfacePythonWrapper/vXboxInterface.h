...
extern "C"
{
	...
	VXBOX_API BOOL	__cdecl	 SetAxisX(UINT UserIndex, int Value); // Left Stick X
	VXBOX_API BOOL	__cdecl	 SetAxisY(UINT UserIndex, int Value); // Left Stick Y
	VXBOX_API BOOL	__cdecl	 SetAxisRx(UINT UserIndex, int Value); // Right Stick X
	VXBOX_API BOOL	__cdecl	 SetAxisRy(UINT UserIndex, int Value); // Right Stick Y
